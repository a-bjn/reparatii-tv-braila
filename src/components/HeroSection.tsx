...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[50vh] bg-[#131212] z-100 overflow-visible">
      <div className="w-full h-full flex items-center overflow-visible">
        <div className="w-2/3 flex flex-col h-full text-start p-4 pr-10 py-10">
          <div className="flex flex-col gap-4 mb-12">
            ...
            <p className="text-zinc-300 font-bold text-sm max-w-lg drop-shadow-md">
        ...
        <div className="w-1/3 relative h-full overflow-visible">
          ...
          <div className="absolute w-[140%] h-full left-[-40%] [clip-path:circle(80%_at_140%_50%)] overflow-visible">
            <Image
              src="/hero.jpg"
              alt="Background"
              fill
